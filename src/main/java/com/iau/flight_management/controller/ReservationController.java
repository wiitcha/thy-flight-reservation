...
import com.iau.flight_management.service.EntityMapper;
...
public class ReservationController {
    ...
    @GetMapping
    public String showReservations(Model model, HttpServletRequest request) throws JsonProcessingException {
